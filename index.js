...
// Image Storage Engine with configuration
...
app.post("/signup", async (req, res) => {
  ...
  await user.save();
  // jwt authentication with salting
  const data = {
    user: {
      id: user.id,
    },
...
//creation endpoint for newcollection
...
//creation endpoint to get cartdata;
